...
<p data-visibility='hidden'>View <a href='https://learn.co/lessons/cssi-4-python-group-mario-stretch-lab' title='Itsa Mario*'>Itsa Mario*</a> on Learn.co and start learning to code for free.</p>
